...
connection.connect((err) => {
  ...
  connection.query(query, (err, results) => {
    ...
    const dataToSend = {
      workouts: results, // Asumiendo que 'results' contiene los registros de la consulta SQL
    };

    const filePath = "C:\\Users\\Temp Tech\\OneDrive - Caja de Compensacion Familiar de Antioquia COMFAMA\\Escritorio\\API\\src\\database\\bd.json";
